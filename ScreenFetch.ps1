#Name- VictorXLR(github.com/VictorXLR)
#Thank StackOverflow for all the Meme Magic Here
#I take no responsibility for anything that happens to your machine
# P.S. This only works on Windows 10. :)

Add-Type -AssemblyName System.Windows.Forms

####### This Deals with Resolution ########
